...
const demoInfo = [
  {
    text: "The Project is focused on meeting <b>SDG goals #7 (Affordable And Clean Energy), #9 (Industry, Innovation  And Infrastructure) & #13 (Climate Action)</b> and has been <b>successful in achieving 80%</b> of its targeted CO2 emission reduction",
  },
  {
    text: "The developer has <b>previously executed similar projects with a satisfactory performance</b>",
  },
  { text: "The region is <b>vulnerable to cyclones & floods</b>" },
  {
    text: "The <b>recent policy events</b> are expected to have a <b>negative impact</b> on the project",
  },
  {
      ...
      <div>
        <div className="mt-4 box-shadow4 gradient-right border border-[#ccc2ff8f] w-4/5 mx-auto flex flex-col rounded-md p-4 pb-1">
          ...
          <p className="text-center text-[#475569] font-semibold text-[18px] drop-shadow-lg">
            Electric 3W Cargo Medium Scale Project - E3WCMSP000010654
          </p>
